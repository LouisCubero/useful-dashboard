...
export default function Page() {
  ...
  return (
    <>
    {waifuMode ? (
      <main className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#0a0a0a] px-4">
        <pre className="text-[#ff79c6] text-[10px] leading-[1.1] font-mono sm:text-xs md:text-sm">{`
           ██████╗ 
          ██╔════╝ 
          ██║      
     ╔════██║════╗ 
